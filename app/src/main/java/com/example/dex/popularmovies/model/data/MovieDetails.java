...
public final class MovieDetails {
    ...
    private com.example.dex.popularmovies.model.data.VideoList videos;
    @Expose
    @SerializedName("images")
    private ImageList images;
    @Expose
    @SerializedName("reviews")
    private com.example.dex.popularmovies.model.data.ReviewList reviews;
    @Expose
    @SerializedName("recommendations")
    private com.example.dex.popularmovies.model.data.MovieList recommendations;
    @Expose
    @SerializedName("similar_movies")
    private com.example.dex.popularmovies.model.data.MovieList similarMovies;
    ...
    public static MovieDetails initFromContentValues(ContentValues values) {
        ...
        VideoList videos = gson.fromJson(values.getAsString(MovieContract.Movie.COLUMN_VIDEOS), com.example.dex.popularmovies.model.data.VideoList.class);
        ImageList images = gson.fromJson(values.getAsString(MovieContract.Movie.COLUMN_IMAGES), ImageList.class);
        ReviewList reviews = gson.fromJson(values.getAsString(MovieContract.Movie.COLUMN_REVIEWS), com.example.dex.popularmovies.model.data.ReviewList.class);
        MovieList recommendations = gson.fromJson(values.getAsString(MovieContract.Movie.COLUMN_RECOMMENDED_MOVIES), com.example.dex.popularmovies.model.data.MovieList.class);
        MovieList similarMovies = gson.fromJson(values.getAsString(MovieContract.Movie.COLUMN_SIMILAR_MOVIES), com.example.dex.popularmovies.model.data.MovieList.class);
    ...
    public com.example.dex.popularmovies.model.data.VideoList getVideos() {
        return videos;
    }
    ...
    public com.example.dex.popularmovies.model.data.ReviewList getReviews() {
        return reviews;
    }

    public com.example.dex.popularmovies.model.data.MovieList getRecommendations() {
        return recommendations;
    }

    public com.example.dex.popularmovies.model.data.MovieList getSimilarMovies() {
